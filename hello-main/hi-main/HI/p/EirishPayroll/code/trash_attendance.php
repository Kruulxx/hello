...
<body>
  <div class="container" style="margin-top:50px;">
    ...
    <div class="dropdown my-3">
      ...
      <button class="btn btn-outline-success" onclick="archive_all()">Restore</button>
  ...
  <script>
    ...
    function archive_all() {
      ...
      var check = confirm("Are you sure you want to Restore " + count + " items?");
      if (check) {
        jQuery.ajax({
          url: 'restore_attend.php',
          type: 'post',
