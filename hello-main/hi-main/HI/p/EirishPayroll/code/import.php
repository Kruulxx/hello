    ...
    if ($_FILES["file"]["size"] > 0) {
        ...
        while (($getData = fgetcsv($file, 10000, ",")) !== FALSE) {
            ...
            if ($getData[0] != '') {
                ...
                $sql = "INSERT into attendancee (emp_id,name,date,time_in,time_out,status,total_hours) 
                        values ('" . $getData[1] . "','" . $getData[2] . "','" . $getData[3] . "','" . $getData[4] . "','" . $getData[5] . "','" . $getData[6] . "','" . $formatted_time . "')";
